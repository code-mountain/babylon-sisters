var createScene = function () {
    ...
    var CreateTree = function (name, x, y, z, scene, ShadowGenerator, MarbleMaterial, FireMaterial) {
        var trunk = BABYLON.Mesh.CreateCylinder(name + "trunk", 13, 4, 10, 5, 7, scene);
        trunk.position = new BABYLON.Vector3(x, y, z);
        trunk.material = FireMaterial ;

        var leafs = BABYLON.Mesh.CreateSphere(name + "leafs", 20, 7, scene);
        leafs.position = new BABYLON.Vector3(x, y + 5.0, z);
        leafs.material = MarbleMaterial;
    ...
    var CreateTree = function (name, x, y, z, scene, ShadowGenerator, MarbleMaterial, FireMaterial) {
        var trunk = BABYLON.Mesh.CreateCylinder(name + "trunk", 7, 5, 4, 6, 3, scene);
        trunk.position = new BABYLON.Vector3(x, y, z);
        trunk.material = FireMaterial ;
    ...
    var createFontain = function (name, x, y, z, scene, shadowGenerator, fireMaterial, grassMaterial) {
        ...
        fontainGround.material =  grassMaterial;
    ...
    var createTorch = function (name, x, y, z, scene, shadowGenerator, brickMaterial, woodMaterial, marbleMaterial) {
        //createBrickBlock
        ...
        //createWood
        var wood = BABYLON.Mesh.CreateCylinder(name + "wood", 2, 0.25, 0.1, 12, 1, scene); 
        wood.position = new BABYLON.Vector3(x, y + 1, z);
        ...
        shadowGenerator.getShadowMap().renderList.push(wood);
    ...
    var camera = new BABYLON.ArcRotateCamera("Camera", 1, 1.2, 25, new BABYLON.Vector3(10, 5, 0), scene);
    ...
    var fireTexture = new BABYLON.BrickProceduralTexture("fire", 256, scene);
    fireMaterial.diffuseTexture = fireTexture;
    fireMaterial.opacityTexture = fireTexture;

    var brickMaterial = new BABYLON.StandardMaterial(name, scene);
    var brickTexture = new BABYLON.FireProceduralTexture(name + "text", 512, scene);
    ...
    var shadowGenerator = new BABYLON.ShadowGenerator(2000, light);
    ...
    createTorch("torch5", 35, 0.5, 5, scene, shadowGenerator, brickMaterial, woodMaterial, grassMaterial);
    createTorch("torch6", 35, 0.5, -5, scene, shadowGenerator, brickMaterial, woodMaterial, grassMaterial);
